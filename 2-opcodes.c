...
/**
*divide - Function that divides the top two data in a stack, saves it to the
*second top element, point the stack to this entry and then deletes the
*top stack entry.
*
*@stack: Stack data would be stored in
...
/**
*mult - Function that multiplies the top two data in a stack, saves it to the
*second top element, point the stack to this entry and then deletes the
*top stack entry.
*
*@stack: Stack data would be stored in
...
/**
*modulus - Function that divides the top two data in a stack, saves it to the
*second top element, point the stack to this entry and then deletes the
*top stack entry.
*
*@stack: Stack data would be stored in
